...
@section('subtitle', 'Vendor Accounts · Staff View')
...
<div class="bg-white rounded-xl border border-slate-100 overflow-hidden"
    ...
    {{-- Search & Filter Bar --}}
    <form method="GET" action="{{ route('staff.vendors.index') }}" class="px-5 py-4 border-b border-slate-100">
                ...
                <tr style="border-bottom: 1px solid #f8fafc; transition: background 0.1s;"
                    ...
                    <td class="px-5 py-4">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            {{-- Toggle Status --}}
                            <form method="POST"
                                  action="{{ route('staff.vendors.toggle', $vendor) }}"
...
<script>
    ...
    function openEditModal(id, name, username, stallNumber) {
        document.getElementById('editForm').action = `/staff/vendors/${id}`;
    ...
    function openDeactivateModal(id, name) {
        document.getElementById('deactivateForm').action = `/staff/vendors/${id}/toggle`;
    ...
    function openActivateModal(id, name) {
        document.getElementById('activateForm').action = `/staff/vendors/${id}/toggle`;
